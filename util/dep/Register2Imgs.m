function [image2, transformation] = Register2Imgs(reference,image2)
    ...
    for i = 1:length(rotation)
        BImgRot = imrotate(image2, rotation(i),'bilinear','crop');
    ...
    if rotAng ~= 0
        image2 = imrotate(image2, rotAng, 'bilinear', 'crop');
    end
